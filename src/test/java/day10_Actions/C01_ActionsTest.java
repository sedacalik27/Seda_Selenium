...
public class C01_ActionsTest extends TestBase {
    ...
    public void actions() {
        ...
        //Kutuya sag tıklayın?--kutuya sağ tıklayınca alert çıktı
        ...
        //alertteki yazıyı alabilmek için driveri alerte geçirmek zorundayız.


        //Alert'te cikan yazinin"You selected a context menu"oldugunu test edin
        // actual=alert üzerindeki yazıya geçis yap ve yazıyı getir
