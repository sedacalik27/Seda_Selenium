...
public class C04_ActionsTest extends TestBase {
    ...
    public void actions() {
         ...
         */
        //bu method oluşturmadan önce driver.switchTo().frame(0);
    ...
    public void test02() {
        ...
        WebElement drop = driver.findElement(By.xpath("//*[@id='droppable']"));
        Actions actions = new Actions(driver);
        actions.clickAndHold(drag).moveByOffset(105,90).release().perform();//drag webelementini belirttiğim koordinatlara taşı ve bırak dedim
