...
public class C01_CssSelector {
    public static void main(String[] args) throws InterruptedException {
        ...
        WebElement addElementButton1 = driver.findElement(By.cssSelector("button[onclick='addElement()']"));
        for (int i = 0; i < 99; i++) {
        ...
        WebElement deletebuuo= driver.findElement(By.cssSelector("button[class='added-manually']"));
        for (int i = 0; i < 90; i++) {
