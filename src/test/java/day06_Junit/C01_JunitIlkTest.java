...
public class C01_JunitIlkTest {
    ...
    basarak test methodunu oluşturabiliriz.
        Junit frameworkunde testlerimizi istediğimiz bir sıralamada çalıştırmak istersek alfabetik ve
    numerik olarak test methodlarının isimlerini belirtmemiz gerekir.
     */
