...
public class C01_GetTagNameGetAttribute {
    public static void main(String[] args) {
       ...
       // driver.get("https://techproeducation.com/");
        //Arama kutusunu locate edelim
       //WebElement aramakutusu= driver.findElement(By.id("searchHeaderResult"));
                                //WebElement lms = driver.findElement(By.xpath("(//a[@target='_blank'])[7]"));
                                 // lms.click();

        //arama kutusunun tag name'inin input olduğunu test edelim
        //System.out.println("Arama kutusu Web Elementi Tag Name:"+ aramakutusu.getTagName());
       // String gercekTagName= aramakutusu.getTagName();
                                    //System.out.println(lms.getTagName());
